...
// Task 2
let wordFromCodePoints = String.fromCharCode(72, 101, 108, 108, 111); // Your code here

// Task 3
let inputString2 = "Launch";
let firstCharCode = inputString2.charCodeAt(0); // Get code point of first character
